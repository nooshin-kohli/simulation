...
if __name__ == '__main__':
    try:
        ...
        # req_1 = switch_controller([],['hip_joint_position_controller','thigh_joint_position_controller','calf_joint_position_controller','jumper_position_controller'], 2,False,0.0)
        ...
        # req_10 = switch_controller(['hip_joint_effort_controller','thigh_joint_effort_controller','calf_joint_effort_controller','jumper_effort_controller'],[],2,False,0.0)

        #########################################################################################################################################
        
        req_11 = switch_controller([],['hip_joint_effort_controller','thigh_joint_effort_controller','calf_joint_effort_controller'],2,False,0.0)
        ...
        req_20 = switch_controller(['hip_joint_position_controller','thigh_joint_position_controller','calf_joint_position_controller'],[],2,False,0.0)
        # rospy.spin()
